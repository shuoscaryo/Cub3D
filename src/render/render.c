...
static float	move_next_point(t_ray *ray, char **map, int *new_x, int *new_y)
{
	float	tx;
	float	ty;
...
static float	move_first_point(t_ray *ray, char **map, int *new_x, int *new_y)
{
	float	tx;
	float	ty;
